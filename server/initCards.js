...
const insertCard = async (values) => {
  const query = "INSERT IGNORE INTO cards_db.cards(color,text) values " + values;
...
const blackList = [
  ...
  "Why did the _____ have to _____?",
  ...
  "Wonder Twin powers, activate! Shape of _____. Form of _____.",
  ...
  "It was more uncomfortable than _____ at a _____ convention.",
  "Jesus is _____.",
  "Keep your friends close, but your _____ closer.",
  "Kitten thinks of nothing but _____ all day.",
  "Legend of Zelda: The _____ of _____.",
  ...
  "My favorite book is the classic tale of _____, written by _____.",
  "My favorite childhood memory is_____.",
  "My favorite TV channel is the one that shows programs about _____.",
  "My favourite family recipe is _____ and _____ with just a dash of _____.",
  ...
  "Next, on Martha Stewart's Living, spruce up your _____ with _____.",
  "Next, on the Twilight Zone: a parallel universe in which every instance of _____ is replaced by _____.",
  "Nobody puts _____ in a corner.",
  "Nothing beats cuddling with _____ in bed.",
  "Nothing feels better than _____ on _____.",
  ...
  "Remember, _____ is never funny. Unless it involves _____.",
  "Roses are red; Violets are _____; _____ is _____, and so are you.",
  "Say no to _____.",
  ...
  "Sizzler’s special tonight: _____ with a side of _____.",
  ...
  "_____ gives a whole new meaning to _____.",
  "_____ good to the last drop.",
  "_____ in the front seat; _____ in the back seat; gotta make my mind up, which seat can I take?",
  "_____ in the morning, sailors take warning.",
  "_____ is a classic case of _____.",
  "_____ is a gateway to _____.",
  "_____ is a time-saving godsend for busy housewives.",
  "_____ is best enjoyed on the first date.",
  "_____ is dead to me.",
  "_____ is nothing _____ can't fix.",
  ...
  "A hot new alternative medical practice involves placing _____ in _____.",
  "A little-known fact is that Microsoft Windows was originally slated to be the first operating system to include _____.",
  "A little-known provision of Obamacare allows _____ access to _____.",
  "According to an old Romanian superstition, _____ will happen if you Don't _____ before going to bed. ",
  ...
  "Bang _____ Marry _____ Kill _____.",
  "Check your privilege. And _____.",
  "Chili’s special tonight: _____ with a side of _____. ",
  ...
  "Every _____ should be required to get a tattoo of _____.",
  ...
  "CTV presents _____, the story of _____.",
  "If _____ came in two-fours Canada would be more _____?",
  ...
  "After unifying the GST and PST the Government can now afford to provide _____ for _____.",
